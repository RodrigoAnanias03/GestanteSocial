 ...
 * @author JONATAS
 */
@WebServlet(name = "ConfirmarCadastroFamiliar", urlPatterns = {"/ConfirmarCadastroFamiliar"})
public class ConfirmarCadastroFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String id = Decripto(request.getParameter("idFamiliar"));
            
            dao = new FamiliarDAO();
            if (dao.verificaAtivo(Integer.parseInt(id))) {

                dao = new FamiliarDAO();
                dao.ativaFamiliar(Integer.parseInt(id));
