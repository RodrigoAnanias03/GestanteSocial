 ...
 * @author JONATAS
 */
@WebServlet(name = "EditarSenhaUsuario", urlPatterns = {"/EditarSenhaUsuario"})
public class EditarSenhaUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String senhaAtual = Cripto(request.getParameter("senhaAtual"));
            String senhaNova = Cripto(request.getParameter("senha"));

            PerfilDAO dao;
            dao = new PerfilDAO();

            String senhaUsuario = dao.senhaUsuario(obj.getIdUsuario());

            if (senhaAtual.equals(senhaUsuario)) {
                //deu certo
                dao = new PerfilDAO();
                if (dao.alterarSenha(obj.getIdUsuario(), senhaNova)) {
            ...
            System.out.println("Erro em: EditarSenhaUsuario.processRequest()! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
