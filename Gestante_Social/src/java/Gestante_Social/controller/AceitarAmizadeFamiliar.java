 ...
 * @author JONATAS
 */
@WebServlet(name = "AceitarAmizadeFamiliar", urlPatterns = {"/AceitarAmizadeFamiliar"})
public class AceitarAmizadeFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.aceitarSolicitacao(obj.getIdUsuario(), loginFamiliar);
