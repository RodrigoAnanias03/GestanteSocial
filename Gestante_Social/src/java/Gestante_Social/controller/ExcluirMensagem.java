...
import static Gestante_Social.controller.BuscarMensagens.Cripto;
...
public class ExcluirMensagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(dao.excluirMensagem(idMensagem)){
                request.setAttribute("mensagem", "Excluido com sucesso!");
            }else{
                request.setAttribute("mensagem", "Erro ao excluir mensagem!");
            }
            ...
            System.out.println("Erro em: ExcluirMensagem.processRequest()! Erro: "+ex.getMessage());
            ex.printStackTrace();
        }
    }
