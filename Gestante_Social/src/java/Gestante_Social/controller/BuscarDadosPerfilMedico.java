 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarDadosPerfilMedico", urlPatterns = {"/BuscarDadosPerfilMedico"})
public class BuscarDadosPerfilMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Medico medico = dao.buscarDadosMedico(obj.getId());
            
            request.setAttribute("medico", medico);
            request.getRequestDispatcher("editar_perfil_medico.jsp").forward(request, response);
        } catch (Exception ex) {
