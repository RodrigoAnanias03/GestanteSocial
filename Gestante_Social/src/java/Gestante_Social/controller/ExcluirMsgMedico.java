 ...
 * @author JONATAS
 */
@WebServlet(name = "ExcluirMsgMedico", urlPatterns = {"/ExcluirMsgMedico"})
public class ExcluirMsgMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.excluirMensagemMedico(idMensagem)){
                ...
                request.setAttribute("mensagem", "Não foi possível excluir no momento!");
            }
            
            request.getRequestDispatcher("BuscarMensagensDeMedicos").forward(request, response);
