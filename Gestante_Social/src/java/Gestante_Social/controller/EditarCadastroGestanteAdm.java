 ...
 * @author JONATAS
 */
@WebServlet(name = "EditarCadastroGestanteAdm", urlPatterns = {"/EditarCadastroGestanteAdm"})
public class EditarCadastroGestanteAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            obj.setEmail(request.getParameter("emailUsuario"));
            obj.setLogin(request.getParameter("loginUsuario"));
            ...
            String gestacao = request.getParameter("gestacaoUsuario");
            if(!gestacao.equals("")){
                obj.setInicioGestacao(converterData(gestacao));
            }else{
                obj.setInicioGestacao(null);
            }
            obj.setIdUsuario(Integer.parseInt(request.getParameter("idGestante")));
            
            
            AdministradorDAO dao = new AdministradorDAO();
            if(dao.editarPerfilGestante(obj)){
                request.setAttribute("msg", "Alterado com sucesso!");
            }else{
                request.setAttribute("msg", "Houve algum erro ao alterar!!");
            }
            
            request.getRequestDispatcher("buscar_gestante_adm.jsp").forward(request, response);
