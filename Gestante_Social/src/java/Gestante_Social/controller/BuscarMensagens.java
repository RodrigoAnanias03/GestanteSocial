 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarMensagens", urlPatterns = {"/BuscarMensagens"})
public class BuscarMensagens extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Mensagem> msg = dao.buscarMensagens(user.getIdUsuario());

            request.setAttribute("mensagens", msg);

            request.getRequestDispatcher("principal_mensagens.jsp").forward(request, response);

        } catch (Exception ex) {
            request.setAttribute("erro", String.valueOf(ex));
            request.getRequestDispatcher("tela_erro.jsp").forward(request, response);
            System.out.println("Erro em: BuscarMensagens.processRequest()! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
