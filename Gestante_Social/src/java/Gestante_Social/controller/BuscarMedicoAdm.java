 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarMedicoAdm", urlPatterns = {"/BuscarMedicoAdm"})
public class BuscarMedicoAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Medico> medicos = dao.buscarMedicos(nome, email, cpf);
