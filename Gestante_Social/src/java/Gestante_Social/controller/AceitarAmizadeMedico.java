 ...
 * @author JONATAS
 */
@WebServlet(name = "AceitarAmizadeMedico", urlPatterns = {"/AceitarAmizadeMedico"})
public class AceitarAmizadeMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.aceitarSolicitacao(obj.getIdUsuario(), loginMedico);
