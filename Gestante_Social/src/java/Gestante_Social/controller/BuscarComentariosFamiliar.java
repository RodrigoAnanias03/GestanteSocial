 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarComentariosFamiliar", urlPatterns = {"/BuscarComentariosFamiliar"})
public class BuscarComentariosFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("comentarios_usuarios_familiar.jsp").forward(request, response);
        } catch (Exception ex) {
