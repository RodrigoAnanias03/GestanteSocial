 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarFamiliaresGestante", urlPatterns = {"/BuscarFamiliaresGestante"})
public class BuscarFamiliaresGestante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Familiar> familiar = dao.buscarFamiliares(user.getIdUsuario());
            
            
            request.setAttribute("quantidade", familiar.size());
            request.setAttribute("familiar", familiar);
            request.getRequestDispatcher("lista_familiares.jsp").forward(request, response);
