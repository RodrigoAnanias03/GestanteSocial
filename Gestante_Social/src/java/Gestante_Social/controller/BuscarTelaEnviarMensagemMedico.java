 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarTelaEnviarMensagemMedico", urlPatterns = {"/BuscarTelaEnviarMensagemMedico"})
public class BuscarTelaEnviarMensagemMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String loginMedico = Decripto(request.getParameter("loginMedico"));
            
            dao = new BuscarInfoAmigosDAO();
            Medico medico = dao.buscarDadosMedico(loginMedico);
            
            medico.setUsuario(Cripto(loginMedico));
            
            request.setAttribute("medico", medico);
            
            request.getRequestDispatcher("enviar_mensagem_medico.jsp").forward(request, response);
