 ...
 * @author JONATAS
 */
@WebServlet(name = "VerMensagemDeMedico", urlPatterns = {"/VerMensagemDeMedico"})
public class VerMensagemDeMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.alterarStatusMensagemMedico(idMensagem);
            
            
            dao = new MensagensDAO();
            MensagemMedico msg = dao.buscarMensagemMedico(idMensagem);
            
            request.setAttribute("mensagem", msg);
            request.getRequestDispatcher("ver_mensagem_de_medico.jsp").forward(request, response);
