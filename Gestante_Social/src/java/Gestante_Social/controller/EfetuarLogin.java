...
public class EfetuarLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            dao = new EfetuarLoginDAO();
            //verifica se tem cadastro
            if(dao.verificarCadastro(usuario)){
                dao = new EfetuarLoginDAO();
                //verifica se esta ativo
                if(dao.verSituacao(usuario)){
                    //verifica senha
                    dao=new EfetuarLoginDAO();
                    if(dao.verSenha(usuario, senha)){
                        //senha correta
                        dao = new EfetuarLoginDAO();
                        Usuario obj = dao.buscarDados(usuario);
                        ...
                        request.getRequestDispatcher("acesso_gestante.jsp").forward(request, response);
                    }
                }else{
                    //mada email novamente
