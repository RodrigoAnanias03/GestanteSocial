 ...
 * @author JONATAS
 */
@WebServlet(name = "EditarFamiliar", urlPatterns = {"/EditarFamiliar"})
public class EditarFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Familiar user = (Familiar) sessao.getAttribute("usuAutenticado");
                ...
                for (FileItem item : multiparts) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        if (!nomeImagem.equals("")) {
                            ...
                            File ft = new File(request.getServletContext().getRealPath("/img/imgperfilfamiliar").replace("\\build", "")
                            ...
                            dao = new FamiliarDAO();
                            obj.setFoto(dao.pegaNomeImagemFamiliar(user.getId()));
                        }
                    }
