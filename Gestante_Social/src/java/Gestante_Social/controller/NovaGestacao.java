 ...
 * @author JONATAS
 */
@WebServlet(name = "NovaGestacao", urlPatterns = {"/NovaGestacao"})
public class NovaGestacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Date data = converterData(request.getParameter("gestacaoUsuario"));
            String publicar = request.getParameter("publicar");
            
            dao = new PerfilDAO();
            if(dao.novaGestacao(usu.getIdUsuario(), data)){
                
            }
            
            if(publicar.equals("sim")){
                dao=new PerfilDAO();
                dao.publicarNascimento(usu.getIdUsuario(), "NovaGravidez.jpg", "Parabéns à "+usu.getNome()+" pois ela está grávida!");
