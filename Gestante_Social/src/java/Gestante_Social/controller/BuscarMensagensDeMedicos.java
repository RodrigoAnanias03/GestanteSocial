 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarMensagensDeMedicos", urlPatterns = {"/BuscarMensagensDeMedicos"})
public class BuscarMensagensDeMedicos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<MensagemMedico> msg = dao.buscarMensagensMedico(user.getIdUsuario());

            request.setAttribute("mensagens", msg);

            request.getRequestDispatcher("principal_mensagens_de_medico.jsp").forward(request, response);
