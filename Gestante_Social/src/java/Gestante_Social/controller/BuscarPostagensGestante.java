 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarPostagensGestante", urlPatterns = {"/BuscarPostagensGestante"})
public class BuscarPostagensGestante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Postagem> postagens = dao.pegaPost(x, maximo, obj.getIdUsuario());
            request.setAttribute("postagens", postagens);
            request.getRequestDispatcher("postagens_gestante.jsp").forward(request, response);
