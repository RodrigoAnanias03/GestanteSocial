 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarPesquisaGestantes", urlPatterns = {"/BuscarPesquisaGestantes"})
public class BuscarPesquisaGestantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("resultado_amigos_familiar.jsp").forward(request, response);
