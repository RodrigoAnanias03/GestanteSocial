 ...
 * @author JONATAS
 */
@WebServlet(name = "VerMensagem", urlPatterns = {"/VerMensagem"})
public class VerMensagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            dao = new MensagensDAO();
            Mensagem msg = dao.buscarMensagem(idMensagem);
            
            request.setAttribute("mensagem", msg);
            request.getRequestDispatcher("ver_mensagem.jsp").forward(request, response);
