 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarPostagensGestantePessoal", urlPatterns = {"/BuscarPostagensGestantePessoal"})
public class BuscarPostagensGestantePessoal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("postagens_pessoais.jsp").forward(request, response);
