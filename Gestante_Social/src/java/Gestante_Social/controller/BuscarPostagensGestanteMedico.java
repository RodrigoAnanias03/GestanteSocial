 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarPostagensGestanteMedico", urlPatterns = {"/BuscarPostagensGestanteMedico"})
public class BuscarPostagensGestanteMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("postagens_pessoais_medico.jsp").forward(request, response);
        } catch (Exception ex) {
