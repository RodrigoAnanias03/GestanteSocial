 ...
 * @author JONATAS
 */
@WebServlet(name = "VerMensagemMedico", urlPatterns = {"/VerMensagemMedico"})
public class VerMensagemMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.alterarStatusMensagem(idMensagem);
            
            dao = new MensagensMedicasDAO();
            MensagemMedico msg = dao.buscarMensagem(idMensagem);
            
            request.setAttribute("mensagem", msg);
            request.getRequestDispatcher("ver_mensagem_medico.jsp").forward(request, response);
        } catch (Exception ex) {
