 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarPostagensGestanteFamiliar", urlPatterns = {"/BuscarPostagensGestanteFamiliar"})
public class BuscarPostagensGestanteFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String nomeAmigo = Decripto(request.getParameter("nomeamigo"));
            
            dao = new BuscarInfoAmigosDAO();
            usu = dao.buscarDados(nomeAmigo);
            
            dao = new BuscarInfoAmigosDAO();

            ArrayList<Postagem> postagens = dao.pegaPostPessoal(x, maximo, usu.getIdUsuario());
            request.setAttribute("postagens", postagens);
            request.getRequestDispatcher("postagens_pessoais_familiar.jsp").forward(request, response);
        } catch (Exception ex) {
