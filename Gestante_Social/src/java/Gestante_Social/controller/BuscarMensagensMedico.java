 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarMensagensMedico", urlPatterns = {"/BuscarMensagensMedico"})
public class BuscarMensagensMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<MensagemMedico> msg = dao.buscarMensagens(user.getId());

            request.setAttribute("mensagens", msg);

            request.getRequestDispatcher("principal_mensagens_medico.jsp").forward(request, response);
