 ...
 * @author JONATAS
 */
@WebServlet(name = "EditarSenhaMedico", urlPatterns = {"/EditarSenhaMedico"})
public class EditarSenhaMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String senha = Decripto(dao.buscarSenhaMedico(obj.getId()));
            
            if (senhaAtual.equals(senha)) {
                //deu certo
                dao = new PerfilMedicoDAO();
                if(dao.alterarSenhaMedico(obj.getId(), senhaNova)){
