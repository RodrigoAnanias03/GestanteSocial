 ...
 * @author JONATAS
 */
@WebServlet(name = "RecuperarSenhaFamiliar", urlPatterns = {"/RecuperarSenhaFamiliar"})
public class RecuperarSenhaFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        dao = new RecuperarSenhaDAO();
            if(dao.verificaEmailFamiliar(email)){
                String login = null, senha=null;
                dao = new RecuperarSenhaDAO();
                ResultSet rs = dao.pegaDadosFamiliar(email);
                while(rs.next()){
                    login = rs.getString("usuario_familiar");
                    senha = Decripto(rs.getString("senha_familiar"));
                }
                ...
                request.getRequestDispatcher("recup_senha_familiar.jsp").forward(request, response);
            }
