 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarPesquisaGestantesMedico", urlPatterns = {"/BuscarPesquisaGestantesMedico"})
public class BuscarPesquisaGestantesMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("resultado_amigos_medico.jsp").forward(request, response);
        } catch (Exception ex) {
