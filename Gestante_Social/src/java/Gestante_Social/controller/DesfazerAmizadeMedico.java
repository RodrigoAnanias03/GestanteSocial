 ...
 * @author JONATAS
 */
@WebServlet(name = "DesfazerAmizadeMedico", urlPatterns = {"/DesfazerAmizadeMedico"})
public class DesfazerAmizadeMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String loginMedico = request.getParameter("loginMedico");

            BuscarMedicoDAO dao;
            dao = new BuscarMedicoDAO();

            if (dao.exclurAmizade(user.getIdUsuario(), loginMedico)) {
            ...
            if (nomePesquisa == null) {
                ...
                request.getRequestDispatcher("PesquisarMedicos").forward(request, response);
