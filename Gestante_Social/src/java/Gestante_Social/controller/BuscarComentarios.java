 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarComentarios", urlPatterns = {"/BuscarComentarios"})
public class BuscarComentarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("comentarios_usuarios.jsp").forward(request, response);

        } catch (Exception ex) {
            request.setAttribute("erro", String.valueOf(ex));
            request.getRequestDispatcher("tela_erro.jsp").forward(request, response);
            System.out.println("Erro em: BuscarComentarios.processRequest()! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
