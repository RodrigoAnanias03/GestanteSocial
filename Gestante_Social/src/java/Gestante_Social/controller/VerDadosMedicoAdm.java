 ...
 * @author JONATAS
 */
@WebServlet(name = "VerDadosMedicoAdm", urlPatterns = {"/VerDadosMedicoAdm"})
public class VerDadosMedicoAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Medico obj = dao.buscarPerfilMedico(id);
            
            request.setAttribute("Medico", obj);
            request.getRequestDispatcher("dados_medico_adm.jsp").forward(request, response);
