 ...
 * @author JONATAS
 */
@WebServlet(name = "DesativarContaMedicoAdm", urlPatterns = {"/DesativarContaMedicoAdm"})
public class DesativarContaMedicoAdm extends HttpServlet {
