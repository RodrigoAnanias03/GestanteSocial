 ...
 * @author JONATAS
 */
@WebServlet(name = "ComentarPublicacaoMedico", urlPatterns = {"/ComentarPublicacaoMedico"})
public class ComentarPublicacaoMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.cadastrarComentarioMedico(com)){
            ...
            request.getRequestDispatcher("BuscarComentariosMedico").forward(request, response);
