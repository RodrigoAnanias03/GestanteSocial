 ...
 * @author JONATAS
 */
@WebServlet(name = "VerDadosGestanteAdm", urlPatterns = {"/VerDadosGestanteAdm"})
public class VerDadosGestanteAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Usuario obj = dao.buscarPerfilGestante(id);
            
            request.setAttribute("Usuario", obj);
            request.getRequestDispatcher("dados_gestante_adm.jsp").forward(request, response);
