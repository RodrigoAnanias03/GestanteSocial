 ...
 * @author JONATAS
 */
@WebServlet(name = "AtivarMedico", urlPatterns = {"/AtivarMedico"})
public class AtivarMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Enviar_Email envEmail = new Enviar_Email();
            
            AdministradorDAO dao;
            dao = new AdministradorDAO();
            
            if(dao.ativarMedico(Integer.parseInt(id))){
                envEmail.AtivarMedico(email);
            }
            
            
            request.getRequestDispatcher("BuscarSolicitacoesInscMedicas").forward(request, response);
