...
import Gestante_Social.dao.BuscarInfoAmigosFamiliarDAO;
 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarInfoGestantes", urlPatterns = {"/BuscarInfoGestantes"})
public class BuscarInfoGestantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            BuscarInfoAmigosFamiliarDAO dao;
            ...
            dao = new BuscarInfoAmigosFamiliarDAO();
            ...
            if (amigo.getIdUsuario() == obj.getId()) {
                request.setAttribute("situacao_amigo", "Você");
                request.setAttribute("botao", "Você");
            } else {
                dao = new BuscarInfoAmigosFamiliarDAO();
            ...
            BuscarInfoAmigosDAO banco;
            banco = new BuscarInfoAmigosDAO();
            request.setAttribute("maximo", banco.pegaMaximoPostPessoal(amigo.getIdUsuario()));

            request.getRequestDispatcher("perfil_amigo_gestante.jsp").forward(request, response);
