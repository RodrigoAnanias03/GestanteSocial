 ...
 * @author JONATAS
 */
@WebServlet(name = "ComentarPublicacaoFamiliar", urlPatterns = {"/ComentarPublicacaoFamiliar"})
public class ComentarPublicacaoFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.cadastrarComentarioFamiliar(com)){
            ...
            request.getRequestDispatcher("BuscarComentariosFamiliar").forward(request, response);
