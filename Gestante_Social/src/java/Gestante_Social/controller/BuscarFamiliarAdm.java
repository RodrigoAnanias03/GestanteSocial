 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarFamiliarAdm", urlPatterns = {"/BuscarFamiliarAdm"})
public class BuscarFamiliarAdm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Familiar> familiares = dao.buscarFamiliares(nome, email, cpf);
