 ...
 * @author JONATAS
 */
@WebServlet(name = "EfetuarContato", urlPatterns = {"/EfetuarContato"})
public class EfetuarContato extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            obj.setSobrenome(request.getParameter("sobrenome"));
            obj.setCpf(request.getParameter("cpfUsuario"));
            obj.setEmail(request.getParameter("email"));
            obj.setAssunto(request.getParameter("assunto"));
            obj.setMensagem(request.getParameter("mensagem"));
            
            ContatoDAO dao;
            dao = new ContatoDAO();
            if(dao.salvarContato(obj)){
                
                Enviar_Email email = new Enviar_Email();
                email.automaticoContato(obj.getEmail());
