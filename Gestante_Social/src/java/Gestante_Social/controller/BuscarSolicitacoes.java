 ...
 * @author JONATAS
 */
@WebServlet(name = "BuscarSolicitacoes", urlPatterns = {"/BuscarSolicitacoes"})
public class BuscarSolicitacoes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Usuario> amigos = dao.buscarSolicitacoes(obj.getIdUsuario());
            ...
            request.getRequestDispatcher("solicitacoes_amizade.jsp").forward(request, response);

        } catch (Exception ex) {
            request.setAttribute("erro", String.valueOf(ex));
            request.getRequestDispatcher("tela_erro.jsp").forward(request, response);
            System.out.println("Erro em : BuscarSolicitacoes.processRequest()! Erro:" + ex.getMessage());
            ex.printStackTrace();
        }
    }
