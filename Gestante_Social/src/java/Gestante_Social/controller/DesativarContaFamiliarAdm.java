 ...
 * @author JONATAS
 */
@WebServlet(name = "DesativarContaFamiliarAdm", urlPatterns = {"/DesativarContaFamiliarAdm"})
public class DesativarContaFamiliarAdm extends HttpServlet {
