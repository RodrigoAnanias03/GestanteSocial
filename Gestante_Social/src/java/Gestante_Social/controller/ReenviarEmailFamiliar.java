 ...
 * @author JONATAS
 */
@WebServlet(name = "ReenviarEmailFamiliar", urlPatterns = {"/ReenviarEmailFamiliar"})
public class ReenviarEmailFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!dao.verEmail(email)) {
                ...
                dao = new ReenviarEmailDAO();
                url = url.replaceAll("ReenviarEmailFamiliar", "ConfirmarCadastroFamiliar?idFamiliar=" + Cripto(String.valueOf(dao.pegarIdFamiliar(email))));
