 ...
 * @author JONATAS
 */
@WebServlet(name = "DesfazerAmizadeFamiliar", urlPatterns = {"/DesfazerAmizadeFamiliar"})
public class DesfazerAmizadeFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String loginFamiliar = request.getParameter("loginFamiliar");

            BuscarFamiliarDAO dao;
            dao = new BuscarFamiliarDAO();

            if (dao.exclurAmizade(user.getIdUsuario(), loginFamiliar)) {
                request.setAttribute("mensagem", "Exclúido com sucesso!");
            } else {
            ...
            if (nomePesquisa == null) {
                ...
                request.getRequestDispatcher("BuscarFamiliaresGestante").forward(request, response);

            }else{
                
                request.setAttribute("nomePesquisa", nomePesquisa);
                request.getRequestDispatcher("PesquisarFamiliares").forward(request, response);
