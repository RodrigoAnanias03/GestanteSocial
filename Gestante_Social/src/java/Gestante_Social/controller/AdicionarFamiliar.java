 ...
 * @author JONATAS
 */
@WebServlet(name = "AdicionarFamiliar", urlPatterns = {"/AdicionarFamiliar"})
public class AdicionarFamiliar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.AdicionarFamiliar(obj.getIdUsuario(), loginFamiliar)){
