 ...
 * @author JONATAS
 */
@WebServlet(name = "TelaEnviarMensagemMedico", urlPatterns = {"/TelaEnviarMensagemMedico"})
public class TelaEnviarMensagemMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("enviar_mensagem_medico_gestante.jsp").forward(request, response);
