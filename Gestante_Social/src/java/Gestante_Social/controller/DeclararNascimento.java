 ...
 * @author JONATAS
 */
@WebServlet(name = "DeclararNascimento", urlPatterns = {"/DeclararNascimento"})
public class DeclararNascimento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PerfilDAO dao;
            dao = new PerfilDAO();
            if(dao.declararNascimento(usu.getIdUsuario())){
                
            }
            
            if(publicar.equals("sim")){
                dao=new PerfilDAO();
                dao.publicarNascimento(usu.getIdUsuario(), "Nascimento.jpg", "Parabéns à "+usu.getNome()+" pois seu bebê nasceu!!");
