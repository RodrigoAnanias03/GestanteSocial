                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-11">
                                            ...
                                            <div class="col-md-1">
                                                <form id="lermsg" accept-charset="iso-8859-1" action="VerMensagemMedico" method="POST">
                                            ...
                                            <div class="col-md-1">
                                                <form id="excluirmsg" name="excluirmsg" accept-charset="iso-8859-1" action="ExcluirMensagemMedico" method="POST">
                                                    <input type="hidden" id="idMensagem" name="idMensagem" value="<%=obj.getIdMensagem()%>" />
