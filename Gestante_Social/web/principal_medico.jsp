        ...
        <div class="col-lg-8" >
            ...
            <div class="container-fluid" style="margin-top: 10px">
                ...
                <div class="col-md-12" style="margin: 0; padding: 0">
                    ...
                    <center>${quantidade} pacientes</center>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <center>
                                            ...
                                            <form style="margin-bottom: 4px" accept-charset="iso-8859-1" action="BuscarInfoAmigosMedico" method="POST">
                                                <input type="hidden" id="loginAmigo" name="loginAmigo" value="<%=obj.getLogin()%>"/>
                                                <button class="btn btn-block" type="submit">Perfil</button>
                                            </form>
                                            <form style="margin-bottom: 4px" accept-charset="iso-8859-1" action="BuscarDadosGestante" method="POST">
                                                <input type="hidden" id="loginAmigo" name="loginAmigo" value="<%=obj.getLogin()%>"/>
                                                <button class="btn btn-block btn-success" type="submit">Dados</button>
                                            </form>
                                            <form style="margin-bottom: 4px" accept-charset="iso-8859-1" action="TelaEnviarMensagemMedico" method="POST">
                                                <input type="hidden" id="loginAmigo" name="loginAmigo" value="<%=obj.getLogin()%>"/>
                                                <button class="btn btn-block btn-info" type="submit">Mensagem</button>
                                            </form>
