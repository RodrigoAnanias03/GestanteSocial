    ...
    <body style="background-color: white">
        ...
        <div class="col-lg-8" >
            ...
            <div class="container-fluid" style="margin-top: 10px">
                ...
                <center><label style="color: red">${quantidade} médicos encontrados para "${nomePesquisa}"</label></center>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-11">
                                        ...
                                        <%if (obj.getId() == 0) {%>
                                        <form accept-charset="iso-8859-1" action="AdicionarMedico" method="POST">
                                            <input type="hidden" id="loginFamiliar" name="loginMedico" value="<%=obj.getUsuario()%>">
