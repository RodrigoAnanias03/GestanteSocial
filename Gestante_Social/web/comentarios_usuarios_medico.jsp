    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                x += 5;
                $("#conteudo").load("BuscarResultadosComentariosMedico?incremento=" + x + "&maxid=" + maximo + "&idpost=" + id );
                ...
                <div class="col-md-12" style="margin: 0; padding: 0">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                <form action="ComentarPublicacaoMedico" method="POST" accept-charset="iso-8859-1">
