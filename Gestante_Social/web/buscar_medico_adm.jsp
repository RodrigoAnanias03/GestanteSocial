            ...
            <div class="container-fluid" style="margin-top: 13px">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="formulario" action="BuscarMedicoAdm" method="post" accept-charset="iso-8859-1">
                            <div class="col-md-5">
                                <label>Nome:</label>
                    ...
                    <div class="panel-body">
                        ...
                        <div style="margin-top: 5px" class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-2">
                                        <img style="border-radius: 30%; margin-right: 10px" id="blah" src="img/imgperfilmedico/<%=obj.getFoto()%>" alt="your image" width="100px" height="100px" />
                                    </div>
                                    <div class="col-md-10">
                                        ...
                                        <label style="color: red">  <%=obj.getProfissao()%></label>
                                        ...
                                        %>
                                        <form id="lermsg" accept-charset="iso-8859-1" action="VerDadosMedicoAdm" method="POST">
                                        ...
                                        <%} else {%>
                                        <form id="lermsg" accept-charset="iso-8859-1" action="AtivarMedicoAdm" method="POST">
                                            <input type="hidden" id="idMedico" name="idMedico" value="<%=obj.getId()%>" />
