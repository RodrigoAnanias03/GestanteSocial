    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                x += 5;
                $("#conteudo").load("BuscarPostagensGestantePessoal?incremento=" + x + "&maxid=" + maximo + "&nomeamigo=" + nomeAmigo);
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div style="margin-top: 15px"><center>
                                    ...
                                    %>
                                    <br/>
                                    <form accept-charset="iso-8859-1" action="EditarAmizade" method="POST">
                                        <input type="hidden" id="nome_amigo" name="nome_amigo" value="${login_amigo}"/>
                                        <%if (!x.equals("Amigos")) {%>
                                    ...
                                    %>
                                    <form style="margin-top: 5px" accept-charset="iso-8859-1" action="EditarAmizade" method="POST">
                                        <input type="hidden" id="nome_amigo" name="nome_amigo" value="${login_amigo}"/>
