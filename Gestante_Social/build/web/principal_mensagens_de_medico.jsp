            ...
            <div class="container-fluid" style="margin-top: 10px">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <%
                            ArrayList<MensagemMedico> msg = (ArrayList) request.getAttribute("mensagens");
                            for (MensagemMedico obj : msg) {
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-11">
                                            ...
                                            <%if (!obj.getStatusMensagem()) {%>
                                            <label><%=obj.getMedico().getNome()%> <%=obj.getMedico().getSobreNome()%></label>
                                            ...
                                            <div class="col-md-1">
                                                <form id="lermsg" accept-charset="iso-8859-1" action="VerMensagemDeMedico" method="POST">
                                            ...
                                            <div class="col-md-1">
                                                <form id="excluirmsgMedico" name="excluirmsgMedico" accept-charset="iso-8859-1" action="ExcluirMsgMedico" method="POST">
                                                    <input type="hidden" id="idMensagem" name="idMensagem" value="<%=obj.getIdMensagem()%>" />
