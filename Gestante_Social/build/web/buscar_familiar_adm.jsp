            ...
            <div class="container-fluid" style="margin-top: 13px">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form id="formulario" action="BuscarFamiliarAdm" method="post" accept-charset="iso-8859-1">
                            <div class="col-md-5">
                                <label>Nome:</label>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <%
                            ArrayList<Familiar> familiares = (ArrayList) request.getAttribute("familiares");
                            if (familiares != null) {
                                for (Familiar obj : familiares) {
                        ...
                        <div style="margin-top: 5px" class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-2">
                                        <img style="border-radius: 30%; margin-right: 10px" id="blah" src="img/imgperfilfamiliar/<%=obj.getFoto()%>" alt="your image" width="100px" height="100px" />
                                    </div>
                                    <div class="col-md-10">
                                        ...
                                        %>
                                        <form id="lermsg" accept-charset="iso-8859-1" action="VerDadosFamiliarAdm" method="POST">
                                        ...
                                        <%} else {%>
                                        <form id="lermsg" accept-charset="iso-8859-1" action="AtivarFamiliarAdm" method="POST">
                                            <input type="hidden" id="idFamiliar" name="idFamiliar" value="<%=obj.getId()%>" />
