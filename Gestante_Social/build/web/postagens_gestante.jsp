                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-11">
                        ...
                        <form action="BuscarInfoAmigos" method="POST" accept-charset="iso-8859-1">
                            <input type="hidden" id="idAmigo" name="idAmigo" value="<%=loginUserCriptografada%>"/>
                    ...
                    <div class="col-md-12" style="max-width: 70%">
                        <a href="img/imgpostagem/<%=obj.getUrl_imagem()%>"><img class="img-responsive img-thumbnail" style="border-radius: 0%" id="blah" src="img/imgpostagem/<%=obj.getUrl_imagem()%>" alt="Recarregue a página" /></a>
                    </div>
                    <%}%>
                    <div class="col-md-12">
                        <%
                        ...
                        <form action="BuscarComentarios" method="POST" accept-charset="iso-8859-1">
                            ...
                            <input type="hidden" id="idEu" name="idEu" value="${idUsuario}"/>
