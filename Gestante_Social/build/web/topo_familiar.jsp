...
<div class="col-lg-2" style=" height: 100%; margin-top: 10px; padding: 0">
    <ul class="nav navbar-default nav-stacked ">
        ...
        <%
            ...
            if(solicitacoes>0){
        %>
        <li role="presentation"><a href="BuscarSolicitacoesGestanteFamiliar"><center><label style="color: red"><%=solicitacoes%> Solicitações</label></center></a></li>
        
        <%}%>
        <li role="presentation" class="active"><a href="IniciarFamiliar"><center><i class="fa fa-fw fa-caret-up"></i>Início / Recarregar</center></a></li>
