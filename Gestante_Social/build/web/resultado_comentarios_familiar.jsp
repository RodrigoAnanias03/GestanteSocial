            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-md-11">
                        ...
                        %>
                        <form action="BuscarInfoGestantes" method="POST" accept-charset="iso-8859-1">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <%
                        Familiar us = (Familiar) session.getAttribute("usuAutenticado");

                        if (obj.getFamiliar() != null) {
                            if (us.getId() == obj.getFamiliar().getId()) {
                    %>
                    <div class="col-md-12">
                        <form action="ExcluirComentarioFamiliar" method="POST" accept-charset="iso-8859-1">
