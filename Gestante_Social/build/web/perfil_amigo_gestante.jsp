    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                x += 5;
                $("#conteudo").load("BuscarPostagensGestanteFamiliar?incremento=" + x + "&maxid=" + maximo + "&nomeamigo=" + nomeAmigo);
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div style="margin-top: 15px"><center>
                                    ...
                                    %>
                                    <br/>
                                    <form accept-charset="iso-8859-1" action="EditarAmizadeFamiliar" method="POST">
                                    ...
                                    %>
                                    <form style="margin-top: 5px" accept-charset="iso-8859-1" action="EditarAmizadeFamiliar" method="POST">
                                        <input type="hidden" id="login_amigo" name="login_amigo" value="${login_amigo}"/>
