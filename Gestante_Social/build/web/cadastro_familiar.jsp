    ...
    <body>
        ...
        <div id="oquee" class="content-section-a">
            ...
            <div class="row">
                ...
                <form role="form" action="CadastrarFamiliar" enctype="multipart/form-data" method="post" accept-charset="iso-8859-1">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <center>
                                            ...
                                            <input required="" type='file' id="imagem" name="imagem" accept="image/png, image/jpeg" data-val="true" data-val-regex-pattern="^.*\.(jpg|JPG|jpeg|JPEG|png|PNG|bmp|BMP)$"
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <div class="form-group">
                                            ...
                                            <input value="<%=obj.getEmail()%>" maxlength="50" type="email" id="emailUsuario" name="emailUsuario" class="form-control" required="" placeholder="exeplo@email.com">
                                    ...
                                    <div class="col-lg-10 text-center">
                                        <div class="form-group">
                                            ...
                                            <input value="<%=obj.getCidade()%>" maxlength="50" class="form-control" id="cidadeUsuario" name="cidadeUsuario" required="" placeholder="Insira sua cidade">
                                        </div>
                                    </div>
