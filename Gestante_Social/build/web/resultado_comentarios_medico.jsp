        ...
        <%}else{%>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <%
                        Medico me = (Medico) session.getAttribute("usuAutenticado");

                        if (obj.getMedico() != null) {
                            if (me.getId() == obj.getMedico().getId()) {
                    %>
                    <div class="col-md-12">
                        <form action="ExcluirComentarioMedico" method="POST" accept-charset="iso-8859-1">
